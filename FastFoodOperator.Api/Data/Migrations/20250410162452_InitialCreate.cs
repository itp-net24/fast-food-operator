...
namespace FastFoodOperator.Api.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CompletedAt", "CreatedAt", "CustomerNote", "OrderNumber", "OrderStatus" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 12, 0, 0, 0, DateTimeKind.Utc), "5kg extra onion", 1001, true },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 2, 12, 0, 0, 0, DateTimeKind.Utc), "no peanuts", 1002, false }
                });
