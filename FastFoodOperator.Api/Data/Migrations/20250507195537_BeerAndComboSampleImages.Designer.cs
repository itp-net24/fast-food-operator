...
namespace FastFoodOperator.Api.Data.Migrations
{
    ...
    [Migration("20250507195537_BeerAndComboSampleImages")]
    partial class BeerAndComboSampleImages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FastFoodOperator.Api.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BasePrice = 24.99m,
                            ImageUrl = "https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/EU/chains/mcd_sweden/81f26208cd24bc87543d25761560d32b.png?width=%s",
                        ...
                        new
                        {
                            Id = 2,
                            BasePrice = 29.99m,
                            ImageUrl = "https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/EU/chains/mcd_sweden/e09c5023b2af710a69b84051b612953e.png?width=%s",
            ...
            modelBuilder.Entity("FastFoodOperator.Api.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 33,
                            BasePrice = 40.00m,
                            Description = "A refreshing glass of our in-house beer",
                            ImageUrl = "https://i.pinimg.com/736x/dd/73/da/dd73da849ff553b4a75a09cd4159c62e.jpg",
                            Name = "Beer"
                        });
                });
